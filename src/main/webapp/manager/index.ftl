...
<html lang="zh">
 <head>
	<title><#if app?has_content>${app.basicTitle}<#else></#if>内容管理系统</title>
	<link rel="shortcut icon" href="${basePath}/images/ms.ico"/>     
	<link rel="bookmark" href="${basePath}/images/ms.ico"/> 
...
<body style="overflow-y:hidden;">	
    ...
    <div class="ms-top  navbar-fixed-top">
        <!--头部LOGO-->
        <div class="ms-top-logo"><img src="${basePath}/images/logo.png" style="width:90px"/></div>
        <!--
    ...
    <div class="ms-content" style="padding:40px 0px 0px 0px">
    	<#if managerModelPage?has_content>
     	...
     	<#else>
     	<!--style="background-image: url(${static}/loading.gif);  background-repeat: no-repeat;  background-position: center;"-->
     		<iframe  src="${basePath}/manager/page.html" frameborder="0" height="100%" width="100%" id="mainFrame" name="mainFrame" ></iframe>
     	</#if>    
        <!--修改登录密码模态框-->
